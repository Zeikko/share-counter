...
class Apilog extends CActiveRecord
{
    ...
    public static function log($request, $response, $responseCode, $totalTime)
    {
        if (isset(Yii::app()->params['apiLogLevel'])) {
            if (Yii::app()->params['apiLogLevel'] == 'all' || Yii::app()->params['apiLogLevel'] == 'error' && $responseCode != 200) {
                $apilog = new Apilog();
